...
mkdir -p ledger/policies ledger/audit ledger/receipts/manifests ledger/verifications/manifests ledger/xlinks/manifests ledger/audit_bundles/manifests ledger/daily_roots
